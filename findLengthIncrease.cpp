...
int main(){
    ...
    while(1){
        ...
        if(v==0)
            ...
            cout<<endl<<endl<<"Do you want to \"Increase Your Linked List\"?(If \"YES type 1\", If \"NO type 0\"): ";cin>>v;
            while(1){
                if(v==0)
                    break;
                else if(v==1){
                ...
                cout<<endl<<endl<<"Do you want to \"Increase Your Linked List\" again?(If \"YES type 1\", If \"NO type 0\"): ";cin>>v;
            }
        }
        else
            cout<<endl<<"Wrong keyword! Type again."<<endl;
